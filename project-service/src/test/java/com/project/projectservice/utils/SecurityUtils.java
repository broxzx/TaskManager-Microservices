...
public class SecurityUtils {
    ...
    public static final String mockedAuthorizationHeaderWithAnonymousUser = "Bearer ";

    public static final String mockedTokenWithAnonymousUser = mockedAuthorizationHeaderWithAnonymousUser.substring(7);
